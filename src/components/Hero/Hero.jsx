             ...
             <div className="grid grid-cols-1 sm:grid-cols-2">
               {/* text content section */}
                ...
                data-aos-delay="300">
                  ...
                  className="bg-gradient-to-r from-primary/50
                   to-secondary/90 hover:scale-105 duration-200
