          ...
          className="text-3xl sm:text-4xl font-bold">
            ...
            className="text-sm text-gray-500 tracking-wide
             leading-5">
              ...
              Deleniti asperiores aliquid quia distinctio porro 
              labore quibusdam voluptatem, provident, 
              sequi voluptate fuga non quos nisi! 
              Officiis ipsam sunt accusamus ea quo?
            </p>
